...
func buy(issuer string, paperNumber string, currentOwner string, newOwner string, price string, purchaseDateTime string) (int, error) {
	log.Println("============ 启动 Buy ============")
	...
	log.Println("--> 提交交易: buy()函数, 购买商业票据")
	result, err := contract.SubmitTransaction("buy", issuer, paperNumber, currentOwner, newOwner, price, purchaseDateTime)
	if err != nil {
